...
/******************************************************************************/
#define AI_ALL_MODEL_NAME          "all"
#define AI_ALL_ORIGIN_MODEL_NAME   "all"

/******************************************************************************/
#define AI_ALL_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_ALL_IN_NUM        (1)

AI_DEPRECATED
#define AI_ALL_IN \
  ai_all_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ALL_IN_SIZE { \
  AI_ALL_IN_1_SIZE, \
}
#define AI_ALL_IN_SIZE_BYTES { \
  AI_ALL_IN_1_SIZE_BYTES, \
}
#define AI_ALL_IN_1_HEIGHT      (87)
#define AI_ALL_IN_1_WIDTH       (16)
#define AI_ALL_IN_1_CHANNEL     (1)
#define AI_ALL_IN_1_SIZE        (87 * 16 * 1)
#define AI_ALL_IN_1_SIZE_BYTES  (5568)

/******************************************************************************/
#define AI_ALL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ALL_OUT \
  ai_all_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ALL_OUT_SIZE { \
  AI_ALL_OUT_1_SIZE, \
}
#define AI_ALL_OUT_SIZE_BYTES { \
  AI_ALL_OUT_1_SIZE_BYTES, \
}
#define AI_ALL_OUT_1_CHANNEL     (6)
#define AI_ALL_OUT_1_SIZE        (6)
#define AI_ALL_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_ALL_N_NODES (8)
 ...
 * @ref ai_all_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_ALL_*
 * defines into file @ref all.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
