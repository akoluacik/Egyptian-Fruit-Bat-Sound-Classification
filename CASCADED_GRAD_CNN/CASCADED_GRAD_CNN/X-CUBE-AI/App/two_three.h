...
#ifndef AI_TWO_THREE_H
#define AI_TWO_THREE_H
#pragma once
...
/******************************************************************************/
#define AI_TWO_THREE_MODEL_NAME          "two_three"
#define AI_TWO_THREE_ORIGIN_MODEL_NAME   "node_2_3"

/******************************************************************************/
#define AI_TWO_THREE_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_TWO_THREE_IN_NUM        (1)

AI_DEPRECATED
#define AI_TWO_THREE_IN \
  ai_two_three_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TWO_THREE_IN_SIZE { \
  AI_TWO_THREE_IN_1_SIZE, \
}
#define AI_TWO_THREE_IN_SIZE_BYTES { \
  AI_TWO_THREE_IN_1_SIZE_BYTES, \
}
#define AI_TWO_THREE_IN_1_HEIGHT      (87)
#define AI_TWO_THREE_IN_1_WIDTH       (16)
#define AI_TWO_THREE_IN_1_CHANNEL     (1)
#define AI_TWO_THREE_IN_1_SIZE        (87 * 16 * 1)
#define AI_TWO_THREE_IN_1_SIZE_BYTES  (5568)

/******************************************************************************/
#define AI_TWO_THREE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_TWO_THREE_OUT \
  ai_two_three_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_TWO_THREE_OUT_SIZE { \
  AI_TWO_THREE_OUT_1_SIZE, \
}
#define AI_TWO_THREE_OUT_SIZE_BYTES { \
  AI_TWO_THREE_OUT_1_SIZE_BYTES, \
}
#define AI_TWO_THREE_OUT_1_CHANNEL     (2)
#define AI_TWO_THREE_OUT_1_SIZE        (2)
#define AI_TWO_THREE_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_TWO_THREE_N_NODES (8)
 ...
 */
AI_API_ENTRY
ai_bool ai_two_three_get_report(
  ai_handle network, ai_network_report* report);
 ...
 * using @ref ai_two_three_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_two_three_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_two_three_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_TWO_THREE_*
 * defines into file @ref two_three.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_two_three_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_TWO_THREE_H */
