...
#define AI_NET_OBJ_INSTANCE g_two_three
 
#undef AI_TWO_THREE_MODEL_SIGNATURE
#define AI_TWO_THREE_MODEL_SIGNATURE     "5344f830fb25904fb3f368b1e04b5229"
...
#define AI_TOOLS_DATE_TIME   "Tue May 31 22:34:43 2022"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_TWO_THREE_N_BATCHES
#define AI_TWO_THREE_N_BATCHES         (1)
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_conv2d_4_input0_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
AI_TENSOR_OBJ_DECLARE(
  serving_default_conv2d_4_input0_output, AI_STATIC,
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 16, 87), AI_STRIDE_INIT(4, 4, 4, 4, 64),
  1, &serving_default_conv2d_4_input0_output_array, NULL)

/* Tensor #1 */
AI_TENSOR_OBJ_DECLARE(
  conv2d_0_output, AI_STATIC,
  1, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 4, 22), AI_STRIDE_INIT(4, 4, 4, 64, 256),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  3, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 1, 6), AI_STRIDE_INIT(4, 4, 4, 64, 64),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  22, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 8, 2), AI_STRIDE_INIT(4, 4, 4, 64, 512),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_conv2d_4_input0_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_0_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    6656, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_TWO_THREE_IN_NUM, &serving_default_conv2d_4_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_TWO_THREE_OUT_NUM, &nl_11_output),
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_TWO_THREE_MODEL_NAME,
      .model_signature   = AI_TWO_THREE_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_i32 ai_two_three_forward(ai_handle network, const ai_buffer* input)
{
